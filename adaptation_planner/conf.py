...
LISTEN_EVENT_TYPE_QUERY_SCHEDULING_PLAN_REQUESTED = config('LISTEN_EVENT_TYPE_QUERY_SCHEDULING_PLAN_REQUESTED')
...
PUB_EVENT_TYPE_QUERY_SCHEDULING_PLANNED = config('PUB_EVENT_TYPE_QUERY_SCHEDULING_PLANNED')

PUB_EVENT_LIST = [
    PUB_EVENT_TYPE_QUERY_SCHEDULING_PLANNED,
]
